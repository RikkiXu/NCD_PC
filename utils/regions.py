...
class SemanticKITTIRestrictedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, t):
        ...
        import os
        if os.path.exists("/public/home/xurj/my/NOPS/superpoint/SemanticKITTI/0.2_2/"+str(self.data_splits)+"/" + str(t) + '.pkl'):
            pass
        else:
            import pickle
            ...
            if labels1[mapped_labels == self.unseen_id].shape[0] >= 1:
                ...
                region_id = None
            with open("/public/home/xurj/my/NOPS/superpoint/test/"+str(self.data_splits)+"/" + str(t) + '.pkl', "wb") as f:
...
class SemanticPOSSRestrictedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, t):
        ...
        with open("/public/home/xurj/my/NOPS/superpoint/3/"+str(t)+'.pkl', "wb") as f:
            pickle.dump(region_id, f)
