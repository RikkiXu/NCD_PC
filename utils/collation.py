...
def collation_fn_restricted_dataset(data_labels):
    coords, feats, labels, selected_idx, mapped_labels, _, _, pcd_indexes = list(zip(*data_labels))
...
def collation_fn_restricted_dataset_two_samples(data_labels):
    coords, feats, labels, selected_idx, mapped_labels,superpoint_lab, selected_region_idx, coords1, feats1, labels1, selected_idx1, mapped_labels1, superpoint_lab1 , selected_region_idx1, pcd_indexes= list(zip(*data_labels))
    ...
    return bcoords, feats, labels, selected_idx, mapped_labels, superpoint_lab, selected_region_idx, bcoords1, feats1, labels1, selected_idx1, mapped_labels1, superpoint_lab1, selected_region_idx1, pcd_indexes
'''
def collation_fn_restricted_dataset_two_samples(data_labels):
